...
```bash
git clone https://github.com/usegalaxy-eu/docker-cellxgene.git
cd docker-cellxgene
...
```bash
docker pull quay.io/bgruening/cellxgene:latest
```
